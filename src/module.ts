...
export const plugin = new PanelPlugin<StreamgraphOptions>(StreamGraphPanel).setPanelOptions((builder) => {
  return builder
    ...
    .addSelect({
      ...
      settings: {
        options: [
          { value: ColorScheme.CIVIDIS, label: 'Cividis', description: 'D3' },
          { value: ColorScheme.TURBO, label: 'Turbo', description: 'D3' },
          { value: ColorScheme.VIRIDIS, label: 'Viridis', description: 'D3' },
          { value: ColorScheme.SPECTRAL, label: 'Spectral', description: 'D3' },
          { value: ColorScheme.PLASMA, label: 'Plasma', description: 'D3' },
          { value: ColorScheme.INFERNO, label: 'Inferno', description: 'D3' },
          { value: ColorScheme.MAGMA, label: 'Magma', description: 'D3' },
          { value: ColorScheme.COOL, label: 'Cool', description: 'D3' },
          { value: ColorScheme.WARM, label: 'Warm', description: 'D3' },
          { value: ColorScheme.RAINBOW, label: 'Rainbow', description: 'D3' },
          { value: ColorScheme.GRAFANA_CLASSIC, label: 'Classic', description: 'Grafana' },
          { value: ColorScheme.GRAFANA_GR_YL_RD, label: 'Green-Yellow-Red', description: 'Grafana' },
          { value: ColorScheme.GRAFANA_RD_YL_GR, label: 'Red-Yellow-Green', description: 'Grafana' },
          { value: ColorScheme.GRAFANA_BL_YL_RD, label: 'Blue-Yellow-Red', description: 'Grafana' },
          { value: ColorScheme.GRAFANA_YL_RD, label: 'Yellow-Red', description: 'Grafana' },
          { value: ColorScheme.GRAFANA_BL_PU, label: 'Blue-Purple', description: 'Grafana' },
          { value: ColorScheme.GRAFANA_YL_BL, label: 'Yellow-Blue', description: 'Grafana' },
          { value: ColorScheme.GRAFANA_BLUES, label: 'Blues', description: 'Grafana' },
          { value: ColorScheme.GRAFANA_REDS, label: 'Reds', description: 'Grafana' },
          { value: ColorScheme.GRAFANA_GREENS, label: 'Greens', description: 'Grafana' },
          { value: ColorScheme.GRAFANA_PURPLES, label: 'Purples', description: 'Grafana' },
        ],
      },
    })
    .addSliderInput({
